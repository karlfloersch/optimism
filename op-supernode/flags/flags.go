...
const EnvVarPrefix = "SUPERNODE_"

// Flags defines the CLI flags for op-supernode.
// Keep names stable to avoid breaking existing invocations.
var Flags = []cli.Flag{
	&cli.StringFlag{Name: "supernode.config", Value: "", Usage: "Path to multi-chain JSON config (overrides per-chain flags)"},
	...
	&cli.StringFlag{Name: "supernode.data-dir", Value: "", Usage: "Supernode data dir (denylist.json and chain DBs). Default is a unique temp dir."},
